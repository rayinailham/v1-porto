...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    const moveHandler = (e: MouseEvent) => {
      // Check if cursor is inside the project details container
      const elementUnderMouse = document.elementFromPoint(e.clientX, e.clientY);
      const isInContainer = elementUnderMouse?.closest('.project-details-container');
      
      if (isInContainer && !isActiveRef.current) {
        ...
        createSpinTimeline();
      } else if (!isInContainer && isActiveRef.current) {
